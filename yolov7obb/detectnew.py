...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        # gwang add
        max_det = 1000
        pred = non_max_suppression_obb(pred, opt.conf_thres, opt.iou_thres, opt.classes, opt.agnostic_nms, multi_label=True, max_det=max_det)
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                # gwang add
                save_conf, save_crop, hide_conf = False, False, False
